<html>
    ...
    <section style="width:50%;margin-left:10%;padding: 1% 2% 5% 2%;">
        <h2  class="h2nav"><p class="text--sub">welcome to the </p>STUDENT HOUSE<br> FACILITIES <p style="width:100%;" class="text--normal">With the understanding of the role that accommodation plays supporting 
